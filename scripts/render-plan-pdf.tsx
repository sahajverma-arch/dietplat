...
interface Payload { cuisine: string; dietType: string; target: Dy["totals"]; weeklyAverage: Dy["totals"]; days: Dy[] }
    ...
    <Document>
      <Page size="A4" style={s.page}>
        <View style={s.header}>
          <View style={s.headerRow}>
            <View style={s.headerLeft}>
              ...
              <Text style={s.hLine}>Week 1 · 7-day plan · Prepared by —</Text>
        ...
        <Text style={s.footer}>
          ...
          Built to a directly-prescribed macro target (no counselling roadmap on file, so no BMI/TDEE is shown).
